...
const _mailScheme = "mailto";

void chooseContactReason(BuildContext context, WidgetRef ref) {
          ...
          ElevatedButtonFullWidth(
            ...
            onPressed: () => launchUrl(
              Uri(
                ...
                query: _buildQueryParameters(context, ref, _ContactType.bug),
              ),
            ),
          ),
          ElevatedButtonFullWidth(
          ...
          ElevatedButtonFullWidth(
            ...
            onPressed: () => launchUrl(
              Uri(
                ...
                query: _buildQueryParameters(context, ref, _ContactType.other),
              ),
            ),
          ),
        ],
